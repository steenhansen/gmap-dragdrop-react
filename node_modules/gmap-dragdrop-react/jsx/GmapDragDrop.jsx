...
// auto	"use strict"
  ...
  _latLngDrop(drop_event) {
    console.log('_latLngDrop', drop_event)
    ...
    console.log('scrolled_x', scrolled_x)
    console.log('drop_event.pageX', drop_event.pageX)
    let marker_pos_x = drop_event.pageX - viewportOffset.left - scrolled_x
    console.log('marker_pos_x', marker_pos_x)
  ...
  _onDropOnMap_react(drop_event) {
    ...
    console.log('_onDropOnMap_react', text_data)
    if (text_data) {
  ...
  _latLngToObj(str_array_obj_funcs) {
    console.log('str_array_obj_funcs', str_array_obj_funcs)
