...
const map_styles = require('./map_styles.jsx')
...
// auto	"use strict"
  ...
  static NO_BUSINESS_STYLE = map_styles.NO_BUSINESS_STYLE
  static RETRO_STYLE = map_styles.RETRO_STYLE
  static NIGHT_STYLE = map_styles.NIGHT_STYLE
  ...
  _latLngDrop(drop_event) {
    ...
    const lat_lng_func = this._convertXyToLatLng({x: marker_pos_x, y: marker_pos_y})
  ...
  _onDragEnd_Overlay(_drag_event) {
    this._stopDragging()
    this._gmapDragDrop_vars.mouse_is_up = true
  }
  ...
  _convertXyToLatLng(mouse_pos) {
    ...
    const lat_lng_funcs = google_map.getProjection().fromPointToLatLng(world_point)
...
GmapDragDrop.propTypes = {
  ...
  , map_styles: PropTypes.array      // GmapDragDrop.NIGHT_STYLE
