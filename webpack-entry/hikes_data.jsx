...
const CAN_MOVE_HIKES = false     /// CANNOT BE TRUE, the indexes are not handled ....
...
const swan_peak_img = GmapSvgIcon.standardMapImage("swan_falls.jpg")
let SWAN_SUMMIT = {
...
const WOOD_PATHS_IMG = GmapSvgIcon.standardMapImage("above_pumping_station.jpg")
...
const FORD_IMG = GmapSvgIcon.standardMapImage("portage.jpg")
let FORD_STREAM = {
...
const CYPRESS_IMG = GmapSvgIcon.standardMapImage("cypress_lake.jpg")
...
const WHITE_ROCK_IMG = GmapSvgIcon.standardMapImage("white_rock.jpg")
...
const WEST_RAMPART_IMG = GmapSvgIcon.standardMapImage("coquitlam_lake.jpg")
let WEST_RAMPART = {
...
const BEAUTIFUL_IMG = GmapSvgIcon.standardMapImage("jelly_eggs.jpg")
let BEAUTIFUL_LAKE = {
...
const ALOUETTE_TOP_IMG = GmapSvgIcon.standardMapImage("maggie_alouette.jpg")
...
const MUNRO_OUTLOOK_IMG = GmapSvgIcon.standardMapImage("minnekhada.jpg")
let OUTLOOK_VIEW = {
...
const MUNRO_SWIM_IMG = GmapSvgIcon.standardMapImage("swim_munro.jpg")
let MUNRO_LAKE = {
...
const MUNRO_LAKE_IMG = GmapSvgIcon.standardMapImage("munro_lake.jpg")
let MUNROE_LOOKOUT = {
...
const DENNET_LAKE_A_IMG = GmapSvgIcon.standardMapImage("dennet_lake.jpg")
let DENNETT_LAKE = {
