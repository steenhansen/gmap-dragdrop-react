...
var hikes_data = __webpack_require__(7);
var BURKE_MOUNTAIN_HIKE = hikes_data.BURKE_MOUNTAIN_HIKE,
...
var gmap_hikes = ReactDOM.render(React.createElement(GmapGroups, {
...
module.exports = {
  gmap_hikes: gmap_hikes, GmapDragDrop: GmapDragDrop, GmapSvgIcon: GmapSvgIcon,
...
var CAN_MOVE_HIKES = false; /// CANNOT BE TRUE, the indexes are not handled ....
...
var SWAN_BIKE = {
  ...
  marker_svg: GmapSvgIcon.BIKE_PATH,
  can_move: CAN_MOVE_HIKES,
  pin_color: SWAN_COLOR,
...
SWAN_BIKE.extra_text = GmapKms.getKms(SWAN_PARKING, SWAN_BIKE);
...
SWAN_WALK.extra_text = GmapKms.getKms(SWAN_BIKE, SWAN_WALK);
...
SWAN_SWIM.extra_text = GmapKms.getKms(SWAN_WALK, SWAN_SWIM);

var swan_peak_url = "http://fieldandforest.co/adventures/halvorlunden";
var swan_peak_img = GmapSvgIcon.standardMapImage("swan_falls.jpg");
var SWAN_SUMMIT = {
  location_id: "SWAN_SUMMIT",
  lat: 49.367926602842765,
  lng: -122.82982729375362,
  marker_svg: GmapSvgIcon.MOUNTAIN_PATH,
  can_move: CAN_MOVE_HIKES,
  pin_color: SWAN_COLOR,
...
SWAN_SUMMIT.extra_text = GmapKms.getKms(SWAN_SWIM, SWAN_SUMMIT);
...
var WOOD_PATHS_IMG = GmapSvgIcon.standardMapImage("above_pumping_station.jpg");
...
WOOD_PATHS.extra_text = GmapKms.getKms(BASTION_PARKING, WOOD_PATHS);

var FORD_IMG = GmapSvgIcon.standardMapImage("portage.jpg");
var FORD_STREAM = {
...
FORD_STREAM.extra_text = GmapKms.getKms(WOOD_PATHS, FORD_STREAM);

var CYPRESS_IMG = GmapSvgIcon.standardMapImage("cypress_lake.jpg");
...
CYPRESS_LAKE.extra_text = GmapKms.getKms(WOOD_PATHS, CYPRESS_LAKE);

var WHITE_ROCK_IMG = GmapSvgIcon.standardMapImage("white_rock.jpg");
...
WHITE_ROCK.extra_text = GmapKms.getKms(CYPRESS_LAKE, WHITE_ROCK);

var WEST_RAMPART_URL = "http://www.buntzenlake.ca/west-rampart-viewpoint/";
var WEST_RAMPART_IMG = GmapSvgIcon.standardMapImage("coquitlam_lake.jpg");
var WEST_RAMPART = {
...
WEST_RAMPART.extra_text = GmapKms.getKms(WHITE_ROCK, WEST_RAMPART);
...
ALOUETTE_PARKING.extra_text = GmapKms.getKms(ALOUETTE_MOUNTAIN, ALOUETTE_PARKING);
...
ALOUETTE_LOOKOUT.extra_text = GmapKms.getKms(ALOUETTE_PARKING, ALOUETTE_LOOKOUT);

var BEAUTIFUL_IMG = GmapSvgIcon.standardMapImage("jelly_eggs.jpg");
var BEAUTIFUL_LAKE = {
...
BEAUTIFUL_LAKE.extra_text = GmapKms.getKms(ALOUETTE_LOOKOUT, BEAUTIFUL_LAKE);
...
var ALOUETTE_BRANCH = {
  ...
  marker_svg: GmapSvgIcon.LEFT_PATH,
  can_move: CAN_MOVE_HIKES,
  pin_color: ALOUETTE_COLOR,
...
ALOUETTE_BRANCH.extra_text = GmapKms.getKms(BEAUTIFUL_LAKE, ALOUETTE_BRANCH);

var ALOUETTE_TOP_IMG = GmapSvgIcon.standardMapImage("maggie_alouette.jpg");
...
ALOUETTE_TOP.extra_text = GmapKms.getKms(ALOUETTE_BRANCH, ALOUETTE_TOP);
...
var MUNRO_OUTLOOK_IMG = GmapSvgIcon.standardMapImage("minnekhada.jpg");
var OUTLOOK_VIEW = {
...
OUTLOOK_VIEW.extra_text = GmapKms.getKms(BURKE_MOUNTAIN, OUTLOOK_VIEW);

var MUNRO_SWIM_IMG = GmapSvgIcon.standardMapImage("swim_munro.jpg");
var MUNRO_LAKE = {
...
MUNRO_LAKE.extra_text = GmapKms.getKms(OUTLOOK_VIEW, MUNRO_LAKE);

var MUNRO_LAKE_IMG = GmapSvgIcon.standardMapImage("munro_lake.jpg");
var MUNROE_LOOKOUT = {
...
MUNROE_LOOKOUT.extra_text = GmapKms.getKms(MUNRO_LAKE, MUNROE_LOOKOUT);

var DENNET_LAKE_A_IMG = GmapSvgIcon.standardMapImage("dennet_lake.jpg");
var DENNETT_LAKE = {
...
DENNETT_LAKE.extra_text = GmapKms.getKms(MUNRO_LAKE, DENNETT_LAKE);
