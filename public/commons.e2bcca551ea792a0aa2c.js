...
var _reactClass = __webpack_require__(17);
...
var map_styles = __webpack_require__(9);
  ...
  _createClass(GmapDragDrop, [{
    ...
    value: function _canvasIeSvg() {
      ...
      var svg_style = {
        ...
        //   <use id={IE_USE_XLINK_ID} xlinkHref={symbol_id} x={0} y={0}/>
    ...
    value: function _mouseOverMarker_googleListener(map_marker, lat_lng_obj) {
      /// drag 1
      var self = this;
      map_marker.addListener('mouseover', function (_event) {
    ...
    value: function _onDragEnd_Overlay(_drag_event) {
      this._stopDragging();
      this._gmapDragDrop_vars.mouse_is_up = true;
    }
  }, {
    ...
    value: function _convertXyToLatLng(mouse_pos) {
      ...
      var lat_lng_funcs = google_map.getProjection().fromPointToLatLng(world_point);
      return lat_lng_funcs;
    }
  }, {
    key: 'validLatLng',
    ...
    value: function _googleEvents() {
      ...
      google_map.addListener('zoom_changed', this._onZoomChanged_googleListener // user control
      );google_map.addListener('center_changed', this._onCenterChanged_googleListener // user control
...
GmapDragDrop.NO_BUSINESS_STYLE = map_styles.NO_BUSINESS_STYLE;
GmapDragDrop.RETRO_STYLE = map_styles.RETRO_STYLE;
GmapDragDrop.NIGHT_STYLE = map_styles.NIGHT_STYLE;
...
GmapDragDrop.propTypes = {
  ...
  , map_styles: _react.PropTypes.array // GmapDragDrop.NIGHT_STYLE
...
var GmapSvgIcon = function () {
  function GmapSvgIcon() {
    _classCallCheck(this, GmapSvgIcon);
  }

  _createClass(GmapSvgIcon, null, [{
    ...
    value: function clear_all(clear_all_options) {
      var clear_all_defaults = GmapSvgIcon.initSvg(clear_all_options);
    ...
    value: function initSvg(clear_all_options) {
      GmapSvgIcon.unique_class_count++;
      var unique_class = GmapSvgIcon.unique_class_count;
      var clear_all_defaults = GmapSvgIcon.insertDefault(clear_all_options);
...
var GmapKms = function () {
  function GmapKms() {
    _classCallCheck(this, GmapKms);
  }

  _createClass(GmapKms, null, [{
    ...
    value: function getDistance(p1, p2) {
      ...
      var a = Math.sin(dLat / 2) * Math.sin(dLat / 2) + Math.cos(GmapKms.degreesToRadians(p1.lat)) * Math.cos(GmapKms.degreesToRadians(p2.lat)) * Math.sin(dLong / 2) * Math.sin(dLong / 2);
    ...
    value: function getKms(p1, p2) {
      var meter_distance = GmapKms.getDistance(p1, p2);
...
var _GmapDragDrop2 = __webpack_require__(0);
...
var RETRO_STYLE = [{ elementType: "geometry", stylers: [{ color: "#ebe3cd" }] }, {
...
var NIGHT_STYLE = [{ elementType: "geometry", stylers: [{ color: "#242f3e" }] }, {
  elementType: "labels.text.stroke",
...
module.exports = {
  NO_BUSINESS_STYLE: NO_BUSINESS_STYLE, RETRO_STYLE: RETRO_STYLE, NIGHT_STYLE: NIGHT_STYLE
};
...
var autoBind = __webpack_require__(16);
